'use client';
import { IndiaStatesField, DadabadiForm } from '@/app/lib/dadabadidefinitions';
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                defaultValue={dadabadi.titlehin}
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                defaultValue={dadabadi.contactname}
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                defaultValue={dadabadi.contactnumber}
          ...
          <div className="rounded-md border border-gray-200 bg-white px-[14px] py-3">
            <div className="flex gap-4">
              ...
              <input
                  ...
                  type="radio"
                  value="available"
                  defaultChecked={dadabadi.bhojanshala === 'available'}
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="notavailable"
                  defaultChecked={dadabadi.bhojanshala === 'notavailable'}
                  aria-describedby="bhojanshala-error"
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                />
                <label
          ...
          <div className="rounded-md border border-gray-200 bg-white px-[14px] py-3">
            <div className="flex gap-4">
              ...
              <input
                  ...
                  type="radio"
                  value="available"
                  defaultChecked={dadabadi.dharmshala === 'available'}
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="notavailable"
                  defaultChecked={dadabadi.dharmshala === 'notavailable'}
                  aria-describedby="dharmshala-error"
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                />
                <label
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                defaultValue={dadabadi.websiteurl}
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                defaultValue={dadabadi.socialmediaurl}
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                defaultValue={dadabadi.trustname}
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                defaultValue={dadabadi.moolnayakname}
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                defaultValue={dadabadi.dadaguruname}
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <textarea
                ...
                defaultValue={dadabadi.description}
          ...
          <div className="rounded-md border border-gray-200 bg-white px-[14px] py-3">
            <div className="flex gap-4">
              ...
              <input
                  ...
                  type="radio"
                  value="published"
                  defaultChecked={dadabadi.published === 'published'}
                ...
                <label
                  ...
                  className="ml-2 flex cursor-pointer items-center gap-1.5 rounded-full bg-green-500 px-3 py-1.5 text-xs font-medium text-white"
                >
                  Yes Publish<CheckIcon className="h-4 w-4" />
                </label>
              </div>
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="notpublished"
                  defaultChecked={dadabadi.published === 'notpublished'}
                  aria-describedby="published-error"
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                />
                <label
                  ...
                  className="ml-2 flex cursor-pointer items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1.5 text-xs font-medium text-gray-600"
                >
                  No UnPublish<XMarkIcon className="h-4 w-4" />
                </label>
              </div>
            </div>            
          </div>
