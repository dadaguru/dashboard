...
const FormSchema = z.object({ 
  ...
  contactnumber: z.string({required_error: "Contact number is required", invalid_type_error: 'Please provide contact number.' }),
  ...
  city: z.string({required_error: "City is required", invalid_type_error: 'Please provide name of area where dadabadi is located.' }),
  description: z.string({ invalid_type_error: 'Please provide the importance of this dadabadi.' }),
  address: z.string({required_error: "Address is required", invalid_type_error: 'Please provide address of dadabadi.' }),
  contactname: z.string({required_error: "Contact name is required", invalid_type_error: 'Please provide contact name.' }),
